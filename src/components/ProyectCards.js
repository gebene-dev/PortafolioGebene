...
export default function ProyectCards(props) {
  return (
    <>
        <div className="flex flex-col items-center p-4 border sm:p-6 rounded-xl dark:border-gray-700">
                ...
                <h1 className="mt-4 text-2xl font-semibold text-gray-700 dark:text-white">
                ...
                <a className="mx-2 mt-5" href="https://github.com/gebene-dev" aria-label="Github">
